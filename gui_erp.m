...
%
% 04/09/2017 - Fixed to show GUI in MATLAB R2017a by Baranauskas
...
if strcmp(cmnd_str,'initialize')
    ...
    if size(dat.showingA,1)<=2,
        ...
        cbar_title_fontsize=10; %for some reason a fontsize of 14 cuts off last letter for topoB axis
    else
        topoplotMK(dat.showingA(:,plotted_pts(mx_tpt)),dat.chanlocs(dat.showing_chans), ...
    ...
    objs_change_col(4)=uicontrol(dat.fig_id,...
        'Units','normalized', ...
        'Position',[ 0.505 0.09 0.26 0.075 ],... 
